...
KalmanFilter::KalmanFilter(double q, double r) : q_(q), r_(r), p_(1.), x_(-1.), isFirstCall_(true)
{
}

KalmanFilter::KalmanFilter()  : q_(0.0001), r_(0.01), p_(1.), x_(-1.), isFirstCall_(true)
{
}
...
DfFilter::DfFilter()  : dataCnt_(0), dataSum_(0)
{
}
